...
7. **TIKTOK SAFETY FILTER (CRITICAL - ห้ามโดนแบน):**
   - 🚫 **BANNED WORDS:** ห้ามใช้คำว่า "ตาย", "ฆ่า", "ศพ", "เลือด", "บุหรี่", "เหล้า", "เบียร์", "สูบ", "ยา", "แทง", "ยิง" โดยเด็ดขาด
   - ✅ **SAFE ALTERNATIVES (ใช้คำเลี่ยงแทนตามบริบท):**
     - **ตาย/ฆ่า/ศพ** -> "ขิต", "ตุย", "สู่ขิต", "เรียบร้อย", "เกม", "ไปหวัน", "ย้ายเซิร์ฟ"
     - **บุหรี่/สูบ/ยา** -> "ไปสูดอากาศ", "เติมพลัง", "พักสายตา", "พ่นควัน", "ขนม"
     - **เหล้า/เบียร์** -> "น้ำเก็กฮวย", "น้ำเปลี่ยนนิสัย", "วิตามิน", "น้ำลำไย"
     - **เลือด/รุนแรง** -> "ซอสมะเขือเทศ", "สีแดง", "งานเข้า", "แยมสตรอเบอร์รี่"
   - **REASON:** TikTok AI Sensitivity is high. Use metaphor/slang to bypass filters.
